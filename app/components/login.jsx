...
const Forget=()=>{
    ...
    return (
        <div>
            <form className=" md:w-full  xl:w-[90%] max-w-md space-y-2 gap-4 flex flex-col p-6 justify-center  ">
                ...
                <div className="w-full">
                    <div>
                        <div className="flex justify-between items-center mb-1">
                            ...
                            <label htmlFor="password" className=" text-[#444748] font-medium">
                                Password
                            </label>

                            <p  onClick={Forget} className="text-sm cursor-pointer text-black-500 hover:underline">
                                Forget?
                            </p>
